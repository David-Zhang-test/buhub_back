...
const translations: Record<AppLanguage, PushStrings> = {
  tc: {
    ...
    "fallback.post": "打開 UHUB 查看帖子",
    "fallback.comment": "打開 UHUB 查看評論",
    "fallback.reply": "打開 UHUB 查看回覆",
    "fallback.mention": "打開 UHUB 查看提及",
    "fallback.profile": "打開 UHUB 查看他的主頁",
    "fallback.message": "打開 UHUB 查看新消息",
    "msg.photo": "圖片",
  ...
  sc: {
    ...
    "fallback.post": "打开 UHUB 查看帖子",
    "fallback.comment": "打开 UHUB 查看评论",
    "fallback.reply": "打开 UHUB 查看回复",
    "fallback.mention": "打开 UHUB 查看提及",
    "fallback.profile": "打开 UHUB 查看他的主页",
    "fallback.message": "打开 UHUB 查看新消息",
    "msg.photo": "图片",
  ...
  en: {
    ...
    "fallback.post": "Open UHUB to view the post.",
    "fallback.comment": "Open UHUB to view the comment.",
    "fallback.reply": "Open UHUB to view the reply.",
    "fallback.mention": "Open UHUB to view the mention.",
    "fallback.profile": "Open UHUB to view their profile.",
    "fallback.message": "Open UHUB to view the new message.",
    "msg.photo": "Photo",
    "msg.photos": "{count} photos",
