...
export const metadata: Metadata = {
  title: "Terms of Service - ULinks",
  description: "ULinks Terms of Service / 用户协议（服务条款）",
};
      ...
      <article>
        ...
        <section className="mt-6 space-y-4">
          ...
          <p className="text-gray-700">
            ULinks is a community platform designed for university students. By
        ...
        <section className="mt-6 space-y-4">
          ...
          <p className="text-gray-700">
            You must be at least <strong>13 years old</strong> to use ULinks. The
      ...
      <article>
        ...
        <section className="mt-6 space-y-4">
          ...
          <p className="text-gray-700">
            ...
            ULinks。本服务面向大学生。创建账号即表示您符合上述条件。
          </p>
        </section>
